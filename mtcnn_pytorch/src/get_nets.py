...
class PNet(nn.Module):
    ...
    def __init__(self):
        ...
        weights = np.load(os.path.join(_cur_dir, 'weights/pnet.npy'))[()]
...
class RNet(nn.Module):
    ...
    def __init__(self):
        ...
        weights = np.load(os.path.join(_cur_dir, 'weights/rnet.npy'))[()]
        for n, p in self.named_parameters():
            p.data = torch.FloatTensor(weights[n])
...
class ONet(nn.Module):
    ...
    def __init__(self):
        ...
        weights = np.load(os.path.join(_cur_dir, 'weights/onet.npy'))[()]
        for n, p in self.named_parameters():
            p.data = torch.FloatTensor(weights[n])
